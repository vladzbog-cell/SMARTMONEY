...
COMPOSITION_PROMPT = (
    ...
    '} ]\n\n'
    "Правила:\n"
    "1. Первый слайд — cover с острым тезисом (не декоративное 'Презентация'), "
    "второй — agenda (3-6 пунктов из evidence.outline), последний — takeaways.\n"
    ...
    "4. speaker_notes — 3-5 предложений разговорных заметок как у ведущего NotebookLM: "
    "контекст, важный нюанс, инсайт, связка со следующим слайдом. Никаких 'это слайд о …'.\n"
    ...
    "7. Заголовок слайда — короткий и информативный (до 8 слов), содержит смысл, а не тему. "
    "Вместо 'Обзор рынка' — 'Рынок вырос на 14% за квартал'. Вместо 'Выводы' — 'Что это значит для инвестора'.\n"
    "8. Bullets пиши в стиле editorial: 'сущность — вывод' (через тире или двоеточие). "
    "Максимум 14 слов, никаких вложенных пунктов. Избегай штампов ('важно отметить', 'стоит подчеркнуть').\n"
    "9. subtitle на cover — лид-предложение, раскрывающее обещание презентации, а не повтор заголовка.\n"
    "10. Повествование должно быть плотным: каждый слайд добавляет новый факт/угол, а не перефразирует предыдущий.\n"
)
